    ...
    <StyledFooter>
      ...
      <FooterGrid>
        <AboutDiv>
          ...
          <AboutPDescription>{`At Performance Clear Bra, protecting your vehicle is the passion that drives what we do in the heart of the Dallas-Fort Worth area. That’s why we set the highest standards for ourselves to meet your paint protection needs, serving drivers across DFW with exceptional care. From choosing the best products for your vehicle to meticulously handling every detail in our clear bra installations, we have two quality standards that are met on every car we work on: 1) everything performs exceptionally well, and 2) it does so for a very long time. With our SunTek certified installers boasting over 30+ years of combined industry experience, we guarantee your car will receive the highest quality of care found anywhere in Dallas-Fort Worth. We put those years of experience to work for you by selecting the finest products and using the most advanced installation methods to ensure your vehicle gets the best long-term protection, no matter what the tough Texas conditions throw at it.`}</AboutPDescription>
        </AboutDiv>
